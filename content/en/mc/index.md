...
Simple, clean, long-term, and fun.

::mc-feature-grid
:::mc-feature{title="Never Reset" tag="🧱 Never Reset"}
Your builds and progress stay — no periodic map wipes.
:::
:::mc-feature{title="Vanilla First" tag="🍃 Vanilla First"}
Minimal gameplay changes for a true vanilla survival feel.
:::
:::mc-feature{title="Always Updated" tag="✨ Always Updated"}
We aim to stay on the latest release while keeping stability.
:::
:::mc-feature{title="High Freedom" tag="🎈 High Freedom"}
Do anything you want — as long as it follows the rules.
:::
::
